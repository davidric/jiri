...
class CreateSampleData extends Migration
{
    ...
    {
        // Order statuses
        \Jiri\JKShop\Models\OrderStatus::insert([
            [
                'title' => 'New Order - Cash on Delivery',  
                'color' => '#f1c40f',   
                'active' => 1,  
                'send_email_to_customer' => 1,  
                'attach_invoice_pdf_to_email' => 0, 
                ...
                'active' => 1,  
                'send_email_to_customer' => 1,  
                'attach_invoice_pdf_to_email' => 1, 
                'mail_template_id' => null,
            ], [
                'title' => 'Expedited Order - Cash on Delivery',    
                'color' => '#27ae60',   
                'active' => 1,  
                'send_email_to_customer' => 1,  
                'attach_invoice_pdf_to_email' => 1, 
        ...
        // Carrier
        \Jiri\JKShop\Models\Carrier::insert([
            [
                'id' => 1,
                'title' => 'Carrier',
                'active' => 1,
                'transit_time' => '2 days',
                'speed_grade' => 0,
                'tracking_url' => 'http://exampl.com/track.php?num=@',
                'free_shipping' => 0,
                'tax_id' => 1,
                'billing' => 2,
                'billing_total_price' => '{\"1\":{\"from\":\"0\",\"to\":\"999999999999\",\"price\":\"11\"}}',
                'billing_weight' => '{\"1\":{\"from\":\"0\",\"to\":\"9999\",\"price\":\"3.99\"}}',
                'maximum_package_width' => null,
                'maximum_package_height' => null,
                'maximum_package_depth' => null,
                'maximum_package_weight' => null,
            ]
        ]);        
